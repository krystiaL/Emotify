...
name_backbone_model = os.path.join(os.getcwd(), "FER_static_ResNet50_AffectNet.pt")
# name_backbone_model = "fer/FER_static_ResNet50_AffectNet.pt"
...
min_tracking_confidence=0.5) as face_mesh:
    ...
    with open('emotions.txt','w') as f:
        f.writelines((emotions))
    with open('emotion_most.txt','w') as f:
        f.writelines((Counter(emotions).most_common(1)[0][0]))
    vid_writer.release()
    cap.release()
