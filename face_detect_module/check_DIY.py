...
def extract_emotion(input_file, lstm_features):
    """
    ...
    min_tracking_confidence=0.5) as face_mesh:
        while cap.isOpened() and (time.time() - start_time) < time_limit:
            ...
            frame_copy = cv2.cvtColor(frame_copy, cv2.COLOR_BGR2RGB) # flame_copy shape is (1920, 1080, 3)
...
# Note: process photos directly when time permits.
            if results.multi_face_landmarks:
                for fl in results.multi_face_landmarks:
                    ...
                    cur_face = frame_copy[startY:endY, startX: endX] # shape is (739, 606, 3)
                    ...
                    '''Extracts features from the preprocessed face image'''
...
summary(pth_backbone_model, (3, 48, 48))
...
extract_emotion(input_file, lstm_features)
